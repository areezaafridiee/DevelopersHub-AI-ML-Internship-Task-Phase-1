...
# ====================================================================
# 1. INITIAL SETUP & ENVIRONMENT LOADING
# ====================================================================
...
# ====================================================================
# 2. PAGE CONFIGURATION & MEMORY STORAGE
# ====================================================================
st.set_page_config(
...
# ====================================================================
# 3. USER INTERFACE STYLING (LAVENDER + DARK/LIGHT COMPATIBLE)
# ====================================================================
st.markdown(
"""
<style>
...
# ====================================================================
# 5. DATA PROCESSING HELPERS & ENGINES
# ====================================================================
...
def format_text_to_html(raw_markdown_text):
    ...
    return f"<p>{final_html_output}</p>"
...
# ====================================================================
# 7. CHAT LOG LOOP & UTILITY BAR RENDER PROCESS
# ====================================================================

for current_index, message_item in enumerate(st.session_state.messages):

    # --------------------------------------------------------------
    # CASE 1: User is editing this message
    # --------------------------------------------------------------
    if (
    ...
    # --------------------------------------------------------------
    # CASE 2: Normal message rendering
    # --------------------------------------------------------------
    else:
    ...
    st.divider()
# ====================================================================
# 8. LIVE USER CHAT INTERACTION INPUT BAR
# ====================================================================
